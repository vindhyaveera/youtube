...
import UserProfileMenu from "../../Components/HomeComponents/UserProfileMenu/UserProfileMenu";
...
const Header = () => {
  ...
  // const [issignIn, setIsSignIn] = useState(false); // Manage login state
    ...
    <div>
      <div className="container">
        <div className="start">
          <div className="startinner">
            <svg
              ...
              focusable="false"
              aria-hidden="true"
              onClick={handleImageClick} // Attach the click event handler here
            >
        ...
        <div className="center">
          <div id="search-input" className="searchbox">
            <div className="input-wrapper">
              ...
              ></input>
              <div className="searchimg" onClick={handleSearch}>
                {
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
          ...
          <div id="search-button" className="searchbox-audio">
            <div className="audiochild">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                viewBox="0 0 24 24"
